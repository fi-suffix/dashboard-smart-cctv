    ...
    <form method="POST" action="{{ route('dashboard.camera.update', $camera) }}" class="p-5 space-y-5">
        ...
        <div>
            ...
            <div class="flex gap-2">
                <input id="rtsp_url" name="rtsp_url" type="text" value="{{ old('rtsp_url', $camera->rtsp_url) }}" required placeholder="rtsp://username:password@192.168.1.100:554/stream" class="flex-1 rounded-lg border border-border-subtle bg-dark-elevated px-3.5 py-2.5 text-sm text-text-primary focus:border-accent-blue focus:outline-none">
